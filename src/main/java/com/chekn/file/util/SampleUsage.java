 ...
 * 
 * @author CodeFlagAI
 * @date 2017年2月15日-下午2:56:36
 */
public class SampleUsage {//ExifReadUtils {
    ...
    */
        ...
        for (Directory directory : metadata.getDirectories()) {
            for (Tag tag : directory.getTags()) {
                ...
                if (tagName.equals("Image Height")) {
                	...
                	System.out.println("untrack tag> " + tagName);
            }
    ...
    {
    	File dir = new File("C:\\Users\\CodeFlagAI\\Desktop\\ok\\3106916100000048\\IMG");
    	
    	for(File fie: dir.listFiles()) {
	        ImgInfoBean imgInfoBean = new SampleUsage().parseImgInfo(fie.getPath());
	        System.out.println(imgInfoBean.toString());
    	}
    	
    	/*File testFle = new File("C:\\Users\\CodeFlagAI\\Desktop\\JH14100590\\sdsd.jpg");
    	System.out.println(new Date(testFle.lastModified()).toLocaleString());*/
    }
